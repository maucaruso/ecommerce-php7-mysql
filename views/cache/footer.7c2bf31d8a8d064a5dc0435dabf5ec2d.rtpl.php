    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="footer-menu">
          ...
          <ul>
            <?php require $this->checkTemplate("partials\categories-menu");?>
          </ul>
        </div>
      </div>
...
<!-- Slider -->
<script type="text/javascript" src="/assets/website/js/bxslider.min.js"></script>
<script type="text/javascript" src="/assets/website/js/script.slider.js"></script>
</body>
