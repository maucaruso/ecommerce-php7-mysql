...
class User extends Model 
{
  ...
  const SESSION = "User";
  const SECRET_IV = "3shyQ8XQY&xMckJd";
  const SECRET = "eEWQLnWKyV39nAMe";
  ...
  public static function getForgot($email, $inadmin = true)
  {
    ...
    if (count($results) === 0) {
      ...
      $new_results = $sql->select("CALL sp_userspasswordsrecoveries_create(:iduser, :desip)", array(
        ":iduser"=>$data["iduser"],
